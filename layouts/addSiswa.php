...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO siswa(nisn, nama, alamat, jenis_kelamin, agama, BING, MTK, IPA, IPS, token) VALUES ('$nisn','$nama', '$alamat', '$jenis_kelamin', '$agama', '$bing', '$mtk', '$ipa', '$ips', '$token');");
    if ($sql) {
                ...
                <div class="table-responsive">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Siswa" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Alamat</label>
                            <input type="text" name="alamat" class="form-control" placeholder="Silahkan Masukkan Alamat" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Nilai B.Ing</label>
                                <input type="number" name="bing" class="form-control" placeholder="..." autocomplete="off">
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="token" class="form-control" placeholder="Silahkan Masukkan Token" autocomplete="off">
                        </div>
